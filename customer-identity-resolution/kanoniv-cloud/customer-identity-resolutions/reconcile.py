...
if not API_KEY and not API_TOKEN:
    raise SystemExit("Set KANONIV_API_KEY or KANONIV_ACCESS_TOKEN (get one at app.kanoniv.com)")
...
# Try Arrow path first (Parquet + COPY INTO), fall back to pandas.to_sql()
...
crosswalk_rows = []
# Batch bulk lookups in chunks of 1000
...
try:
    ...
    # Fallback: pandas.to_sql() via SQLAlchemy
